...
private:
    ...
    sf::Texture mTexture,nTexture,oTexture,pTexture,qTexture,rTexture,sTexture,tTexture,uTexture,vTexture,xTexture,yTexture,MenuTexture,bTexture,tHelp1,tHelp2,tChoose,tStats;
    sf::Sprite mPlayer,nPlayer,oPlayer,pPlayer,qPlayer,rPlayer,sPlayer,tPlayer,uPlayer,vPlayer,xPlayer,yPlayer,MenuSprite,bBackground,sHelp1,sHelp2,sChoose,sStats;
    sf::Vector2i source;
    bool stance;
